...
def build_flow_proxies() -> None:
    ...
    if on_cols and off_cols:
        ...
        # Rotation crossovers
        result["rot_cross_5v20"]  = result["rotation_z5"]  - result["rotation_z20"]
        result["rot_cross_5v60"]  = result["rotation_z5"]  - result["rotation_z60"]
        result["rot_cross_20v60"] = result["rotation_z20"] - result["rotation_z60"]
